# Step-wise DDPM evaluation script (full version with visualization)
import os
import torch
...
from models.ddpm2_pn2_tran2 import TransformerDDPMRegNet
...
def main():
    ...
    with torch.no_grad():
        for i, batch in enumerate(dataloader):
            ...
            if SAVE_VTP:
                save_dir = f"./eval_vtp_ddpm2pn2tran2/{folder}"
